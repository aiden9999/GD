...
<div class="inner" style="width: 420px">
	<div class="arrow_wrap">
		<div class="arrow prev" onclick="boardPrev(this)"
			id="boardPrev${start }" style="display: none">
			<img src="/img/sub02_arrow_prev.png">
		</div>
		<div class="arrow next" onclick="boardNext(this)"
			id="boardNext${start }" style="display: none">
		...
		<c:forEach var="i" begin="${start }" end="${end }">
			<c:choose>
				<c:when test="${i==selectPage }">
					<div class="num sel" onclick="boardPage(${i})" id="boardPage${i }"
						style="width: 33px">
						<span>${i }</span>
					</div>
				</c:when>
				<c:otherwise>
					<div class="num" onclick="boardPage(${i})" id="boardPage${i }"
						style="width: 33px">
						<span>${i }</span>
					</div>
				</c:otherwise>
