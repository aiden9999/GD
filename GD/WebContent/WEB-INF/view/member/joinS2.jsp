...
<body>
	...
	<div class="join01-02 join01-03 join01-04 join01-05">
		<div class="inner">
			<div class="tit">
				<div class="icon_wrap">
					<div class="img">
						<img src="/img/login_black_girl.png">
					</div>
					<div class="txt">학생 회원가입 절차</div>
				</div>
				<div class="step">
			...
			<div class="children_wrap">
				...
				<div class="sort_wrap section_wrap">
					...
					<div class="select_box">
						<select id="schooladdr">
							<option value="schoose">학교소재지</option>
                            <option value="서울">서울</option>
                            <option value="인천">인천</option>
                            <option value="세종">세종</option>
                            <option value="대전">대전</option>
					...
					<div class="input">
						<input type="text" placeholder="학교명" id="school">
					</div>
				</div>
				<div class="class_wrap section_wrap">
					<div class="tit">학년</div>
					<div class="select_box">
						<select id="grade">
							<option value="choose">선택</option>
				...
				<div class="series_wrap section_wrap">
					<div class="tit">문/이과</div>
					<div class="radio_wrapper">
						<div class="radio_wrap">
							<div class="input_txt">
								<label><input type="radio" name="series" id="type1">
									문과
								</label>
							</div>
						</div>
						<div class="radio_wrap">
							<div class="input_txt">
								<label><input type="radio" name="series" id="type2">
									이과
								</label>
							</div>
						</div>
						...
						<div class="txt">(고등학교 2학년부터 선택해주세요.)</div>
					</div>
				</div>
 		...
 		function next(){
 			...
 			if(id=="" || nick=="" || pw=="" || pw2=="" || addr1=='choose' || addr2=="" || phone1=='choose' || phone2=="" || phone3=="" ||
				...
				nick = $("#nick").val();
	 			...
	 			$.ajax({
	 				type : "post",
	 				url : "/join/student/"+id+"/"+name+"/"+nick+"/"+pw+"/"+addr1+"/"+addr2+"/"+phone+"/"+agreesms+"/"+agreeemail+
	 						"/"+schooladdr+"/"+school+"/"+grade+"/"+type+"?email="+email,
	 				async : false,
	 				success : function(txt){
	 					if(txt){
	 						$("#end1").show();
